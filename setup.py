#!/usr/bin/env python
"""
Package metadata for courses_list.
"""
import os
import re
import sys
...
VERSION = get_version('courses_list', '__init__.py')
...
setup(
    ...
    url='https://github.com/openedx/courses_list',
    packages=find_packages(
        include=['courses_list', 'courses_list.*'],
        exclude=["*tests"],
    ),
    entry_points={
        "lms.djangoapp": [
            "courses_list = courses_list.apps:CoursesListConfig",
        ]
    },
