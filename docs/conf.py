...
"""
courses_list documentation build configuration file.
...
project = 'courses_list'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'courses_list'
...
#
# html_title = 'courses_list v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'courses_list'),
                os.path.join(root_path, 'courses_list/migrations')])
